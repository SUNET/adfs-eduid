    ...
    $dll = Join-Path $InstallDirectory 'ADFSTK.ExternalMFA.AdapterMerged.dll'
    if(Test-Path $dll)
    {
        ...
        $typeName = "ADFSTK.ExternalMFA.Adapter.ExternalRefedsMFAAdapter, " + $fn.ToString() + ", processorArchitecture=MSIL"
